...
def open_file():
    ...
    # Extract the contents of the first and second cells in the second row
    top_text_en = df.iloc[0, 0]
    top_text_ko = df.iloc[0, 1]
...
def img_create_loop():
    ...
    for index, line in enumerate(contentsen, 1):
        ...
        text_size_en = draw.textsize(line, font=font)
        ...
        y = (image.height - text_size_ko[1] ) / 2 - sentence_space
...
root = Tk()
root.title('En_Ko Mp4 Converter')
root.geometry("800x450")

#Title
title = Label(root, text = "En_Ko Mp4 Converter")
...
font = ImageFont.truetype("/System/Library/Fonts/Supplemental/DIN Alternate Bold.ttf", 90)
font_ko = ImageFont.truetype("/Users/hj/Library/Fonts/KakaoRegular.ttf", 90)

# Create a new font object for the top text
font_top = ImageFont.truetype("/Users/hj/Library/Fonts/KakaoRegular.ttf", 40)
